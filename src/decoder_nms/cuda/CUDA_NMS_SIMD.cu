...
__global__ void LDPC_Sched_Stage_1_NMS_SIMD(unsigned int var_nodes[_N],
	...
	//
	{
		...
		for (int z = 0; z < DEG_1_COMPUTATIONS; z++) {
			...
			t_min2.c[0] = (((float)t_min2.c[0]) * 0.750f);
			t_min2.c[1] = (((float)t_min2.c[1]) * 0.750f);
			t_min2.c[2] = (((float)t_min2.c[2]) * 0.750f);
			t_min2.c[3] = (((float)t_min2.c[3]) * 0.750f);
