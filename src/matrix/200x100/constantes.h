...
#define N                    200 // Nombre de Variables
#define K                    100 // Nombre de Checks   
#define ONE_COUNT            600 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 6
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   8
#define TAILLE_RAM_PNODE     4464 // = taille ram interleaver
#define TAILLE_VALID_RAM     216
#define NB_CYCLE_EXEC        31
